...
**Note: this requires [Docker](https://www.docker.com/get-started) that is at least _18.06_ for the experimental BuildKit support.**
...
\***_Note: the `Context` binding is not an Azure Functions binding; it is used to pass information about the function being invoked._**

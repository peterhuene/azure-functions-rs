...
mod tests {
    ...
    fn it_converts_to_tokens() {
        ...
        assert_eq!(tokens, r#"::azure_functions::codegen::bindings::ServiceBusTrigger{name:::std::borrow::Cow::Borrowed("foo"),queue_name:Some(::std::borrow::Cow::Borrowed("bar")),topic_name:Some(::std::borrow::Cow::Borrowed("baz")),subscription_name:Some(::std::borrow::Cow::Borrowed("jam")),connection:Some(::std::borrow::Cow::Borrowed("cake")),}"#);
    }
}

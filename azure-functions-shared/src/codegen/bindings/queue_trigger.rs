...
#[binding(name = "queueTrigger", direction = "in")]
...
mod tests {
    ...
    fn it_serializes_to_json() {
        ...
        assert_eq!(
            ...
            r#"{"type":"queueTrigger","direction":"in","name":"foo","queueName":"bar","connection":"baz"}"#
        );
    }
    ...
    fn it_requires_the_name_attribute_argument() {
        should_panic(
            || {
                let _: QueueTrigger = (vec![], Span::call_site()).into();
            },
    ...
    fn it_converts_to_tokens() {
        ...
        assert_eq!(tokens, r#"::azure_functions::codegen::bindings::QueueTrigger{name:::std::borrow::Cow::Borrowed("foo"),queue_name:::std::borrow::Cow::Borrowed("bar"),connection:Some(::std::borrow::Cow::Borrowed("baz")),}"#);
    }
}
